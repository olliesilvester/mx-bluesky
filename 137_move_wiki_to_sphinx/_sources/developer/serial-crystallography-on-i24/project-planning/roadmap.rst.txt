...
+---------------------------------------+------------------------------+
| Work Ongoing                          | Rough Timeline               |
+=======================================+==============================+
| ~Tidy up original code and add some   | Summer 23                    |
| tests~                                |                              |
+---------------------------------------+------------------------------+
| ~Generic deployment for edm screens~  | Summer 23                    |
+---------------------------------------+------------------------------+
...
| collections.~                         |                              |
+---------------------------------------+------------------------------+
| Permissions issues - run as a service | Dec. 23                      |
+---------------------------------------+------------------------------+
| Start sending logs to graylog         | Nov. 23                      |
+---------------------------------------+------------------------------+
| ~Come up with a first parameter       | 1st Dec 23                   |
| model~                                |                              |
+---------------------------------------+------------------------------+
| ~Set up a first bluesky plan to move  | 15th Nov. 23                 |
| the detector stage and set up the     |                              |
| detector in use~                      |                              |
+---------------------------------------+------------------------------+
| ~Create an Ophyd device for for the   | 1st Dec. 23                  |
| pmac and use it to move the chip      |                              |
| stages~                               |                              |
+---------------------------------------+------------------------------+
| ~Use a plan to find the fiducials~    | 15th Dec. 23                 |
+---------------------------------------+------------------------------+
| ~Start using Ophyd devices for the    | 15th Dec. 23                 |
| set up tasks - eg. zebra~             |                              |
+---------------------------------------+------------------------------+
| Create an Ophyd device for the        | Jan. 24                      |
| Pilatus detector and use it, along    |                              |
| with the Eiger device, to collect     |                              |
| data                                  |                              |
+---------------------------------------+------------------------------+
| Extruder collections using bluesky    | Feb. 24                      |
+---------------------------------------+------------------------------+
| Chip collections using bluesky        | Jan./Feb. 24                 |
+---------------------------------------+------------------------------+
| ~Document how to set up the current   | Ongoing                      |
