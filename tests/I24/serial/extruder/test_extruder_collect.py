...
@patch("mx_bluesky.I24.serial.extruder.i24ssx_Extruder_Collect_py3v2.save_parameters")
@patch("mx_bluesky.I24.serial.extruder.i24ssx_Extruder_Collect_py3v2.read_parameters")
...
def test_run_extruder(
    fake_sup, fake_caget, fake_caput, fake_nexgen, fake_dcid, fake_params, fake_save
):
    fake_params.return_value = ExperimentParameters(**params)
    run_extruderi24()
